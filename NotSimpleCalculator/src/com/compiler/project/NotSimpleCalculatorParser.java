...
public class NotSimpleCalculatorParser extends Parser {
    ...
    public static class ProgramContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterProgram(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitProgram(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitProgram(this);
    ...
    public static class StatementsContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterStatements(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitStatements(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitStatements(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class StatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitStatement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitStatement(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExprContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterExpr(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitExpr(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitExpr(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class CumTermContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterCumTerm(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitCumTerm(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitCumTerm(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class TermContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterTerm(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitTerm(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitTerm(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FactorContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterFactor(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitFactor(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitFactor(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ParenthesizedExpressionContext extends ExponentContext {
        ...
        public ParenthesizedExpressionContext(ExponentContext ctx) {
            copyFrom(ctx);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterParenthesizedExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitParenthesizedExpression(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitParenthesizedExpression(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class IdentifierContext extends ExponentContext {
        public TerminalNode ID() {
            return getToken(NotSimpleCalculatorParser.ID, 0);
        }

        public IdentifierContext(ExponentContext ctx) {
            copyFrom(ctx);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterIdentifier(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitIdentifier(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitIdentifier(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class NumberContext extends ExponentContext {
        public TerminalNode NUMBER() {
            return getToken(NotSimpleCalculatorParser.NUMBER, 0);
        }

        public NumberContext(ExponentContext ctx) {
            copyFrom(ctx);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterNumber(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitNumber(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitNumber(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Assign_statementContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_assign_statement;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterAssign_statement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitAssign_statement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitAssign_statement(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Begin_endContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_begin_end;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterBegin_end(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitBegin_end(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitBegin_end(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Print_simpleContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_print_simple;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterPrint_simple(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitPrint_simple(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitPrint_simple(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Print_literalContext extends ParserRuleContext {
        public TerminalNode STRING() {
            return getToken(NotSimpleCalculatorParser.STRING, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_print_literal;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterPrint_literal(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitPrint_literal(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitPrint_literal(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class If_thenContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterIf_then(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitIf_then(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitIf_then(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class While_doContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_while_do;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterWhile_do(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitWhile_do(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitWhile_do(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class For_doContext extends ParserRuleContext {
        ...
        public List<TerminalNode> NUMBER() {
            return getTokens(NotSimpleCalculatorParser.NUMBER);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterFor_do(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitFor_do(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitFor_do(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Loop_doContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterLoop_do(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitLoop_do(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitLoop_do(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class CumoprContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterCumopr(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitCumopr(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitCumopr(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class MultiplicativeContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterMultiplicative(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitMultiplicative(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitMultiplicative(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class AdditiveContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).enterAdditive(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof NotSimpleCalculatorListener)
                ((NotSimpleCalculatorListener) listener).exitAdditive(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NotSimpleCalculatorVisitor)
                return ((NotSimpleCalculatorVisitor<? extends T>) visitor).visitAdditive(this);
            else return visitor.visitChildren(this);
        }
    }
